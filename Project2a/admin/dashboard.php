...
<div class="container my-5 py-5" style="background: linear-gradient(45deg, #f5f7fa, #eef2f6); border-radius: 15px; box-shadow: 0 10px 15px rgba(0, 0, 0, 0.1);">
        <h2 class="py-1 text-center mb-5">Welcome, Admin!</h2>

        
            <a href="books.php" class="btn btn-success mr-2 btn-lg">Manage Books</a>
            <a href="authors.php" class="btn btn-success mr-2 btn-lg">Manage Authors</a>
            <a href="categories.php" class="btn btn-success mr-2 btn-lg">Manage Categories</a>
            <a href="comments.php" class="btn btn-success btn-lg">Manage Comments</a>
    </div>
</div>

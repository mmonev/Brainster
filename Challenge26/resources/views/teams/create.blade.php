        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 flex justify-between content-center">
                    <p class="py-2">{{ __("Add new Team") }}</p>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-3">
                <div class="p-6 text-gray-900 flex justify-between content-center">
                    ...
                    <form method="POST" action="{{route('teams.store')}}" class="w-full">
                        @csrf
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" id="founding_year" name="founding_year" value="{{old('founding_year')}}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            @error('founding_year')
                            <div class="p-3 mb-3 text-sm text-red-800"
                                role="alert">
